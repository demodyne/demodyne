...
class SortingDivPaginationHelperWithTotal extends AbstractHelper
{
    ...
    private $post;
    //private $limit;
    public function __invoke($totalResults, $pagedResults, $page, $baseUrl, $div = "", $resultsPerPage=null, $sort=null, $order=null, $filter=null, $post='')
    {
