...
class LogExtra implements ProcessorInterface
{
    ...
    {
        // get request uri, IP address and session id and add it to the extras of the logger
        ...
        // if the event already contains some extra info merge it with the new data
